...
<header>
	...
	<div style=" padding-left: 15%; padding-right: 15%;">
		...
		<div class="m11">
			...
			<input type="text" maxlength="40" class="min" name="title"> 
		</div>

		<div class="m13">
			<label class="lab12">내용 :</label>
			<textarea id="summernote" rows="20" cols="80" name="contents"></textarea>
		</div>
		<div>
			<select name="grade">
		...
		<div class="m12">
               ...
               <div id="attachs">
                  <div>
                    <input type="file" name="attach" class="m10">
                  </div>                  
               </div>               
            </div>
	...
	<div class="b11">
    	<a href="../"><button class="b12">등록</button></a>
    </div>
    </form>
    <div class="b11">
    	<a href="list"><button class="b12">등록 취소</button></a>
    </div>
