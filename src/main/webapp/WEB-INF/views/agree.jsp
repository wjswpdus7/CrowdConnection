...
<body>
 ...
 <h2 class="h2">홈페이지 이용약관</h2>
    ...
    <div class="agree">
        ...
        <p><input type="checkbox" id="chk2"><label for="chk2">홈페이지  이용약관에 동의합니다.(동의하지 않을경우 가입되지 않습니다.)</label></p>
    </div>
    ...
    <div class="agree">
        ...
        <p><input type="checkbox" id="chk3"><label for="chk3">홈페이지  이용약관에 동의합니다.(동의하지 않을경우 가입되지 않습니다.)</label></p>
    </div>
    ...
    <div class="agree">
        ...
        <p><input type="checkbox" id="chk4"><label for="chk4">홈페이지  이용약관에 동의합니다.(동의하지 않을경우 가입되지 않습니다.)</label></p>
    </div>
