...
<body>
        ...
        <div class="list_wrap">
            ...
            <div class="list_contents">
                <div class="item">
                    ...
                    <div class="title">
                        <a href=""><span class="open">진행중</span><strong>CHAT GPT로 수익 올리기</strong></a>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="title">
                        <a href=""><span class="close">종료</span><strong>블로그 운영 비법</strong></a>
                    </div>
                    <div class="information">
                        <p>3일남음</p>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="title">
                        <a href=""><span class="open">진행중</span><strong>면역력 증가 알약</strong></a>
                    </div>
                    <div class="information">
                        <p>6일남음</p>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="title">
                        <a href=""><span class="open">진행중</span><strong>귀여운 빨간공</strong></a>
                    </div>
                    <div class="information">
                        <p>13일남음</p>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="title">
                        <a href=""><span class="open">진행중</span><strong>풍력 발전기</strong></a>
                    </div>
                    <div class="information">
                        <p>20일남음</p>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="title">
                        <a href=""><span class="open">진행중</span><strong>우리아이 첫 신발</strong></a>
                    </div>
                    <div class="information">
                        <p>4일남음</p>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="title">
                        <a href=""><span class="open">진행중</span><strong>맛있는 버섯탕</strong></a>
                    </div>
                    <div class="information">
                        <p>6일남음</p>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="title">
                        <a href=""><span class="open">진행중</span><strong>세종시 맛집 새우탕</strong></a>
                    </div>
                    <div class="information">
                        <p>6일남음</p>
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="title">
                        <a href=""><span class="open">진행중</span><strong>하이볼 메이커</strong></a>
                    </div>
                    <div class="information">
                        <p>6일남음</p>
                    </div>
    ...
    <script>
        function openCloseToc() {
          if(document.getElementById('hidden_search').style.display === 'block') {
